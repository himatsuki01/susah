...
let tag = `@${m.sender.split('@')[0]}`
 ...
 m, { contextInfo: { mentionedJid: conn.parseMention(tag) }}
    ...
    let tks = `Saya adalah *Kagumi-Bot* salah satu Bot Whatsapp yang diciptakan oleh : ${ow}
Silahkan tekan Tombol ${user.registered ? '"Menu"' : '"Verify"'} untuk ${user.registered ? 'melihat list command dari' : 'mendaftar sebelum menggunakan'} Kagumi-Bot.
...
"headerType": "DOCUMENT", "documentMessage": {
            ...
            "jpegThumbnail": await (await fetch('https://telegra.ph/file/b7c31eda6f7560bb08499.jpg')).buffer(),
...
function logos() {
  ...
  if (lgs >= 4) {
    imp = 'https://telegra.ph/file/b7c31eda6f7560bb08499.jpg'
  }
  if (lgs > 10) {
    imp = 'https://telegra.ph/file/ffcf6053078640acf92c6.jpg'
  }
  if (lgs >= 15) {
